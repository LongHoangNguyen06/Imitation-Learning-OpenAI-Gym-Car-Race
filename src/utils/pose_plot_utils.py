...
def get_action_arrow(action: tuple, pose: tuple, conf: Dynaconf) -> tuple:
    """
...
def get_car_orientation_arrow(pose: tuple, length=25) -> tuple:
    """
...
def action_to_string(action: tuple) -> str:
    """
