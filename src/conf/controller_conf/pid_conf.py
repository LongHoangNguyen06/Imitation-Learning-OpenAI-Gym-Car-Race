...
PID_SUB_CONFIGS = [
    [0.01, "src/conf/controller_conf/pid_extras/pid_normal_driver.py"],
    [0.02, "src/conf/controller_conf/pid_extras/pid_corner_1.py"],
    [0.03, "src/conf/controller_conf/pid_extras/pid_corner_2.py"],
    [1000, "src/conf/controller_conf/pid_extras/pid_corner_3.py"],
]
